    ...
    <div className="home-container">
       <main>
        ...
        <div className="box" data-aos="fade-up">
          <h2 style={{ fontSize: '50px', textAlign: 'center' }}>OUR VISION!</h2>
        ...
        <div className="box" data-aos="fade-up" data-aos-delay="200">
          <h2 style={{ fontSize: '50px', textAlign: 'center' }}>WHAT WE DO!</h2>
        ...
        <div className="box" data-aos="fade-up" data-aos-delay="400">
          <h2 style={{ fontSize: '50px', textAlign: 'center' }}>WHY IS IT IMPORTANT!</h2>
